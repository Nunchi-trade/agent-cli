...
app.add_typer(money_app, name="money", help="Money movement — withdraw, deposit, and bridge tests")
app.add_typer(privy_app, name="privy", help="Privy agent policy helpers")
